...
const Header = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-teal-600 via-cyan-600 to-teal-700 w-full shadow-xl sticky top-0 z-50">
      <Wrapper>
        <div className="flex items-center justify-between py-3">
          <div className="flex items-center gap-4">
            ...
            <Link href="/dashboard" onClick={() => trackEvent(MixpanelEvent.Navigation, { from: pathname, to: "/dashboard" })} className="flex items-center gap-3 group">
              <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/10 backdrop-blur-sm transition-all group-hover:bg-white/20 group-hover:shadow-lg">
